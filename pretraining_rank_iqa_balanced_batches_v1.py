...
class RankIQADataset(Dataset):
    def __init__(self, base_dataset, generators, pair_types, rescaling_fn):
...
if __name__ == '__main__':
    ...
    train_ds = RankIQADataset(base_train, generators, pair_types, rescaling_fn)
    test_ds = RankIQADataset(base_test, generators, pair_types, rescaling_fn)
